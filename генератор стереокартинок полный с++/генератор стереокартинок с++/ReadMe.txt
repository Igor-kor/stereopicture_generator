========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта генератор стереокартинок с++
========================================================================

Это приложение генератор стереокартинок с++ создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения генератор стереокартинок с++.


генератор стереокартинок с++.vcxproj
...
генератор стереокартинок с++.vcxproj.filters
...
генератор стереокартинок с++.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем генератор стереокартинок с++.pch и файла предкомпилированных типов с именем StdAfx.obj.
